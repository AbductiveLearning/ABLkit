...
## TODO: 在这个文件里面，把新方法实现一下，让它们能跑通mnist_add的例子。包括：
## 1. A3BL：为了实现A3BL，可能不仅需要加reasoner，Data，ABLModel，Metric等地方可能都需要增加，参考一下A3BL的代码）
## 2. semisupervised：这里要对输入做一些改变，需要设置一个semi-supervised的[0,1]参数，代表多少比例的data是有label的。数据集里面随机挑数据有label
## 3. similarity-based consistency
## 4. ABL with rejection
